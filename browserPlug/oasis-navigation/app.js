    ...
    function importData(event) {
      ...
      reader.onload = async (e) => {
        try {
          ...
          // 询问用户是合并还是覆盖
          const message = '📤 导入数据文件\n\n' +
            '请选择导入方式：\n\n' +
            '【确定】= 合并模式\n' +
            '  • 保留本地所有数据（包括本地独有的分类和网站）\n' +
            '  • 从文件添加新内容\n' +
            '  • 适用于：想保留本地数据，同时获取文件中的新内容\n\n' +
            '【取消】= 覆盖模式（以文件为准）⭐\n' +
            '  • 删除本地所有数据\n' +
            '  • 完全使用文件数据替换\n' +
            '  • 适用于：想要文件和本地完全一致\n\n' +
            '💡 提示：如果您想完全使用备份文件的内容，请选择"覆盖模式"（点击取消）';
    ...
    async function syncFromBaidu() {
      ...
      const message = '📥 从百度网盘恢复数据\n\n' +
        ...
        '  • 保留本地所有数据（包括本地独有的分类和网站）\n' +
        '  • 从网盘添加新内容\n' +
        '  • 适用于：想保留本地数据，同时获取网盘新内容\n\n' +
        '【取消】= 覆盖模式（以网盘为准）⭐\n' +
        '  • 删除本地所有数据\n' +
        '  • 完全使用网盘数据替换\n' +
        '  • 适用于：想要网盘和本地完全一致\n\n' +
        '💡 提示：如果您在网盘删除了某些分类，请选择"覆盖模式"（点击取消）';
